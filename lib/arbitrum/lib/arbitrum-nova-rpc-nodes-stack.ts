...
export interface ArbitrumNovaRpcNodesStackProps extends cdk.StackProps {
...
export class ArbitrumNovaRpcNodesStack extends cdk.Stack {
    constructor(scope: cdkConstructs.Construct, id: string, props: ArbitrumNovaRpcNodesStackProps) {
        ...
        if (props.network !== "nova") {
            throw new Error(`This stack is for Arbitrum Nova. Network '${props.network}' is not supported.`);
        }
        ...
        const instanceSG = new ec2.SecurityGroup(this, "security-group", {
            vpc: vpc,
            description: "Security Group for Arbitrum Nitro RPC nodes (Nova)",
        ...
        new cdk.CfnOutput(this, "alb-url", {
            ...
            description: "Application Load Balancer DNS name for Arbitrum Nova RPC nodes",
        });
